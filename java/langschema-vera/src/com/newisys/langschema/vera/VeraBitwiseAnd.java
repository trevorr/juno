...
/**
 * Represents a Vera bitwise-and operation.
 * 
 * @author Trevor Robinson
 */
public final class VeraBitwiseAnd
    extends VeraBinaryArithmeticOperation
{
    private static final long serialVersionUID = 3691039850740593465L;

    public VeraBitwiseAnd(VeraExpression op1, VeraExpression op2)
    {
        super(op1, op2);
    }
    ...
    public Object evaluateConstant()
    {
        ...
        {
            return IntegerOp.bitwiseAnd((Integer) o1, (Integer) o2);
        }

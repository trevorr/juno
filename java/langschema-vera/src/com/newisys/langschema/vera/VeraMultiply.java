...
/**
 * Represents a Vera multiplication operation.
 * 
 * @author Trevor Robinson
 */
public final class VeraMultiply
    extends VeraBinaryArithmeticOperation
{
    private static final long serialVersionUID = 3257281452809662518L;

    public VeraMultiply(VeraExpression op1, VeraExpression op2)
    {
        super(op1, op2);
    }

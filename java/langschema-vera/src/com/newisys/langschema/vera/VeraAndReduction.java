...
/**
 * Represents a Vera reductive-and operation.
 * 
 * @author Trevor Robinson
 */
public final class VeraAndReduction
    extends VeraReduction
{
    private static final long serialVersionUID = 3258133570026353974L;

    public VeraAndReduction(VeraExpression op1)
    {
        super(op1);
    }
    ...
    public Object evaluateConstant()
    {
        ...
        {
            return IntegerOp.reductiveAnd((Integer) o);
        }
        else if (o instanceof BitVector)
        {
            return ((BitVector) o).reductiveAnd();
        }
        else
        {

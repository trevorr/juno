...
/**
 * Represents a Vera bitwise-not operation.
 * 
 * @author Trevor Robinson
 */
public final class VeraBitwiseNegative
    extends VeraUnaryArithmeticOperation
{
    private static final long serialVersionUID = 3258132436020835379L;

    public VeraBitwiseNegative(VeraExpression op1)
    {
        super(op1);
    }
    ...
    public Object evaluateConstant()
    {
        ...
        {
            return IntegerOp.bitwiseNot((Integer) o);
        }
        else if (o instanceof BitVector)
        {
            return ((BitVector) o).not();
        }
        else
        {

...
/**
 * Represents a Vera reductive-and-not operation.
 * 
 * @author Trevor Robinson
 */
public final class VeraNotAndReduction
    extends VeraReduction
{
    private static final long serialVersionUID = 3257003250514540081L;

    public VeraNotAndReduction(VeraExpression op1)
    {
        super(op1);
    }
    ...
    public Object evaluateConstant()
    {
        ...
        {
            return IntegerOp.reductiveAndNot((Integer) o);
        }
        else if (o instanceof BitVector)
        {
            return ((BitVector) o).reductiveAnd().not();
        }
        else
        {

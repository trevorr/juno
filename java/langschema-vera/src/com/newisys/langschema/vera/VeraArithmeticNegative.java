...
/**
 * Represents a Vera arithmetic negation operation.
 * 
 * @author Trevor Robinson
 */
public final class VeraArithmeticNegative
    extends VeraUnaryArithmeticOperation
{
    private static final long serialVersionUID = 3257288041289824306L;

    public VeraArithmeticNegative(VeraExpression op1)
    {
        super(op1);
    }
    ...
    public Object evaluateConstant()
    {
        ...
        {
            return IntegerOp.negate((Integer) o);
        }
        else if (o instanceof BitVector)
        {
            return ((BitVector) o).negate();
        }
        else
        {

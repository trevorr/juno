...
/**
 * Represents a Vera subtraction operation.
 * 
 * @author Trevor Robinson
 */
public final class VeraSubtract
    extends VeraBinaryArithmeticOperation
{
    private static final long serialVersionUID = 3258688788904751159L;

    public VeraSubtract(VeraExpression op1, VeraExpression op2)
    {
        super(op1, op2);
    }

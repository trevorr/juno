...
/**
 * Represents a Vera greater-than operation.
 * 
 * @author Trevor Robinson
 */
public final class VeraGreater
    extends VeraComparisonOperation
{
    private static final long serialVersionUID = 3978430199958222131L;

    public VeraGreater(VeraExpression op1, VeraExpression op2)
    {
        super(op1, op2);
    }
    ...
    public Object evaluateConstant()
    {
        ...
        {
            return IntegerOp.greater((Integer) io1, (Integer) io2);
        }

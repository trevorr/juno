...
/**
 * Represents a Vera bitwise-xor-not operation.
 * 
 * @author Trevor Robinson
 */
public final class VeraBitwiseXorNot
    extends VeraBinaryArithmeticOperation
{
    private static final long serialVersionUID = 3256439209639292977L;

    public VeraBitwiseXorNot(VeraExpression op1, VeraExpression op2)
    {
        super(op1, op2);
    }

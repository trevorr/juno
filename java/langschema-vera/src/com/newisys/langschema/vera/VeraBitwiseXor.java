...
/**
 * Represents a Vera bitwise-xor operation.
 * 
 * @author Trevor Robinson
 */
public final class VeraBitwiseXor
    extends VeraBinaryArithmeticOperation
{
    private static final long serialVersionUID = 3905522705007980600L;

    public VeraBitwiseXor(VeraExpression op1, VeraExpression op2)
    {
        super(op1, op2);
    }
    ...
    public Object evaluateConstant()
    {
        ...
        {
            return IntegerOp.bitwiseXor((Integer) o1, (Integer) o2);
        }

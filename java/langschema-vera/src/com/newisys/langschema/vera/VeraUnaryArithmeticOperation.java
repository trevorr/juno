...
/**
 * Base class for Vera unary arithmetic operations.
 * 
 * @author Trevor Robinson
 */
public abstract class VeraUnaryArithmeticOperation
    extends VeraUnaryOperation
{
    public VeraUnaryArithmeticOperation(VeraExpression op1)
    {
        super(op1);

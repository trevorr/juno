...
/**
 * Represents a Vera assignment operation.
 * 
 * @author Trevor Robinson
 */
public final class VeraAssign
    extends VeraAssignment
{
    private static final long serialVersionUID = 3689628094956844342L;

    public VeraAssign(VeraExpression op1, VeraExpression op2)
    {
        super(op1, op2);

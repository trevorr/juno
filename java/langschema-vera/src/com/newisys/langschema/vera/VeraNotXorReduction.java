...
/**
 * Represents a Vera reductive-xor-not operation.
 * 
 * @author Trevor Robinson
 */
public final class VeraNotXorReduction
    extends VeraReduction
{
    private static final long serialVersionUID = 3835150662261813298L;

    public VeraNotXorReduction(VeraExpression op1)
    {
        super(op1);
    }
    ...
    public Object evaluateConstant()
    {
        ...
        {
            return IntegerOp.reductiveXorNot((Integer) o);
        }
        else if (o instanceof BitVector)
        {
            return ((BitVector) o).reductiveXor().not();
        }
        else
        {

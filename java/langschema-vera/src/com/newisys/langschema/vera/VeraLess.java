...
/**
 * Represents a Vera less-than operation.
 * 
 * @author Trevor Robinson
 */
public final class VeraLess
    extends VeraComparisonOperation
{
    private static final long serialVersionUID = 3832616270745972792L;

    public VeraLess(VeraExpression op1, VeraExpression op2)
    {
        super(op1, op2);
    }
    ...
    public Object evaluateConstant()
    {
        ...
        {
            return IntegerOp.less((Integer) io1, (Integer) io2);
        }

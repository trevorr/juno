...
/**
 * Represents a Vera division operation.
 * 
 * @author Trevor Robinson
 */
public final class VeraDivide
    extends VeraBinaryArithmeticOperation
{
    private static final long serialVersionUID = 3257285837837056312L;

    public VeraDivide(VeraExpression op1, VeraExpression op2)
    {
        super(op1, op2);
    }
    ...
    public Object evaluateConstant()
    {
        ...
        {
            return IntegerOp.divide((Integer) o1, (Integer) o2);
        }

...
/**
 * Represents a Vera greater-or-equal operation.
 * 
 * @author Trevor Robinson
 */
public final class VeraGreaterOrEqual
    extends VeraComparisonOperation
{
    private static final long serialVersionUID = 3257004358716503605L;

    public VeraGreaterOrEqual(VeraExpression op1, VeraExpression op2)
    {
        super(op1, op2);
    }
    ...
    public Object evaluateConstant()
    {
        ...
        {
            return IntegerOp.greaterOrEqual((Integer) io1, (Integer) io2);
        }

...
/**
 * Base class for Vera binary logical operations.
 * 
 * @author Trevor Robinson
 */
public abstract class VeraBinaryLogicalOperation
    extends VeraBinaryOperation
{
    public VeraBinaryLogicalOperation(VeraExpression op1, VeraExpression op2)
    {
        super(op1, op2);

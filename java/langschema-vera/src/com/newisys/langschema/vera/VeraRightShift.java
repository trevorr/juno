...
/**
 * Represents a Vera right shift operation.
 * 
 * @author Trevor Robinson
 */
public final class VeraRightShift
    extends VeraShiftOperation
{
    private static final long serialVersionUID = 3257844364058440753L;

    public VeraRightShift(VeraExpression op1, VeraExpression op2)
    {
        super(op1, op2);
    }

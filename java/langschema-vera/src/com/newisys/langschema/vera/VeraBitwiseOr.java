...
/**
 * Represents a Vera bitwise-or operation.
 * 
 * @author Trevor Robinson
 */
public final class VeraBitwiseOr
    extends VeraBinaryArithmeticOperation
{
    private static final long serialVersionUID = 4051050765424472118L;

    public VeraBitwiseOr(VeraExpression op1, VeraExpression op2)
    {
        super(op1, op2);
    }
    ...
    public Object evaluateConstant()
    {
        ...
        {
            return IntegerOp.bitwiseOr((Integer) o1, (Integer) o2);
        }

...
/**
 * Base class for Vera arithmetic assignment operations.
 * 
 * @author Trevor Robinson
 */
public abstract class VeraArithmeticAssignment
    extends VeraAssignment
{
    public VeraArithmeticAssignment(VeraExpression op1, VeraExpression op2)
    {
        super(op1, op2);
    ...
    {
        return type1.isStrictIntegral() && type2.isIntegralConvertible();
    }
}

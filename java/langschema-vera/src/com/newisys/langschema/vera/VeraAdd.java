...
/**
 * Represents a Vera addition operation.
 * 
 * @author Trevor Robinson
 */
public final class VeraAdd
    extends VeraBinaryArithmeticOperation
{
    private static final long serialVersionUID = 3618414921537173047L;

    public VeraAdd(VeraExpression op1, VeraExpression op2)
    {
        super(op1, op2);
    }
    ...
    public Object evaluateConstant()
    {
        ...
        {
            return IntegerOp.add((Integer) o1, (Integer) o2);
        }

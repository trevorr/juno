...
/**
 * Represents a Vera bitwise-or-not operation.
 * 
 * @author Trevor Robinson
 */
public final class VeraBitwiseOrNot
    extends VeraBinaryArithmeticOperation
{
    private static final long serialVersionUID = 3761685706174576183L;

    public VeraBitwiseOrNot(VeraExpression op1, VeraExpression op2)
    {
        super(op1, op2);
    }

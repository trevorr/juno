...
/**
 * Represents a Vera bitwise-and-not operation.
 * 
 * @author Trevor Robinson
 */
public final class VeraBitwiseAndNot
    extends VeraBinaryArithmeticOperation
{
    private static final long serialVersionUID = 3617851963027829296L;

    public VeraBitwiseAndNot(VeraExpression op1, VeraExpression op2)
    {
        super(op1, op2);
    }

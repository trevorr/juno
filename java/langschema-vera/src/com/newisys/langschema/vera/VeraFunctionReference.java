...
/**
 * Represents a Vera function reference expression.
 * 
 * @author Trevor Robinson
 */
public final class VeraFunctionReference
    extends VeraExpression
    implements FunctionReference
{
    private static final long serialVersionUID = 3257004350076170294L;

    private final VeraFunction function;

    public VeraFunctionReference(VeraFunction function)
    {
        super(function.schema);
        setResultType(function.getType());

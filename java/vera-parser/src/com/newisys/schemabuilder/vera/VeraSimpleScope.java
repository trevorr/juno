...
/**
 * Scope delegate that delegates to a) the given primary scope, and then b)
 * the enclosing scope (if any).
 * 
 * @author Trevor Robinson
 */
public final class VeraSimpleScope
    extends VeraScopeDelegate
{
    private final Scope scope;

    public VeraSimpleScope(Scope scope, VeraScopeDelegate enclosingScope)
    {
